...
class PadCenterCrop(object):
    """Pad the given PIL Image on all sides with the given "pad" value and then perform a center crop"""
...
class ColorJitter(object):
    """R
    andomly change the brightness, contrast and saturation of an image.
    Args:
