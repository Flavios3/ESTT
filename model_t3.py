...
class Trainer:
    ...
    def train(self):
        ...
        if self.args.style_transfer:
            ...
            self.style_augment = StyleAugment(n_images_per_style = self.args.num_images_per_style, L = self.args.L)
    ...
    def print_results(self):
        ...
        plt.tight_layout()
        os.makedirs(os.path.join('Results','Plots','Plots_T3'), exist_ok=True)
        plt.savefig(os.path.join('Results','Plots','Plots_T3', f'exp_{self.args.n_exp}.png'))
        plt.close(fig)
